...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大数据科技协会', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '勤勤恳恳的打工协会', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bdta.buzzchat.top', // 网站地址
